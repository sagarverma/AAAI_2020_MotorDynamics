...
\begin{poster}{
 ...
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   \headerbox{Modelling Complex Dynamics}{name=abstract,column=0,row=0,span=1}{
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 Electrical motor dynamics modeling relies on physics-based approach. Dynamics are dependent on several physical quantities and operating conditions. Sensors and estimators used for measuring these quantities are not accurate. This makes controller design and monitoring a hard problem.
   }
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   \begin{itemize}
      \item 4-kilowatt induction motor
      \item Acquisition rate: 250 Hz
      \item Seven quantities $i_d, i_q, u_d, u_q,, \omega_r, \omega_s, \tau_{em}$
      \item Simulate data: 100 hours, training: 70\% and validation: 30 \%
...
\end{small}
  ...
  \begin{small}
  \begin{itemize}
    \item This is one of the first work addressing the problem of learning nonlinear dynamics of electrical motors from recorded time-series data.
